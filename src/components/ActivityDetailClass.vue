                  ...
                  <div class="detail">
                    ...
                    <div>
                      <div style="display: flex; flex-direction: column; cursor: pointer;"
                        ...
                        @click="!(subActivityItem.progress[0]) ? addProgress(subActivityItem.subActivityId) : ''">
                        <div>
                          <h4 style="margin: 0">
                            {{ index + 1 }}. {{ subActivityItem.subActivityName }}
                            <svg v-if="(subActivityItem.progress[0]) || cliked" xmlns="http://www.w3.org/2000/svg"
                              viewBox="0 0 1024 1024" width="15" height="15">
                              <path fill="#67C23A"
                                d="M512 64a448 448 0 1 1 0 896 448 448 0 0 1 0-896m-55.808 536.384-99.52-99.584a38.4 38.4 0 1 0-54.336 54.336l126.72 126.72a38.272 38.272 0 0 0 54.336 0l262.4-262.464a38.4 38.4 0 1 0-54.272-54.336z">
                              </path>
                            </svg>
